        ...
        <div class="inner-container">
            <div class="auto-container clearfix">
                ...
                <div class="logo-outer">
                    <div class="logo"><a href="<?= base_url('/') ?>"><img src="<?=base_url('images/logo.jpg')?>" alt="" title=""></a></div>
                </div>
                                ...
                                <li class="dropdown"><a href="#">Our Services</a>
                                    <ul>
                                        <?php foreach ($services as $key => $service) { ?>
                                            <li><a href="<?= base_url('service/'.$service['slug']);?>"><?=$service['title']?></a></li>
                                        <?php  } ?>
                                    </ul>
    ...
    <div class="sticky-header">
        <div class="auto-container clearfix">
            ...
            <div class="logo pull-left">
                <a href="<?= base_url('/') ?>" title=""><img src="<?=base_url('images/logo-small.png')?>" alt="Logo" title="TopNotch Logo"></a>
            </div>
            <!--Right Col-->
